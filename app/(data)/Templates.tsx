export default [
    {
        name: 'Blog Title',
        desc: 'An AI tool that generates blog title according to user input',
        category: 'Blog',
        icon: 'https://cdn-icons-png.flaticon.com/128/9768/9768738.png',
        aiPrompt: 'Give me 5 blog topic ideas in bullet points based on given niche topic and give me result in rich text editor format',
